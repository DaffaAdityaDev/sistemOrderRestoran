            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="dishes.php?res_id=<?php echo $_GET['res_id']; ?>">Pilih Makanan Kesukaan Mu</a></li>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 profile-desc">
                                <div class="pull-left right-text white-txt">
                                    ...
                                    <ul class="nav nav-inline">
                                        <li class="nav-item"> <a class="nav-link active" href="#"><i class="fa fa-check"></i> Min Rp. 10,00</a> </li>
...
?>								  
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                        ...
                        <div class="menu-widget" id="2">
                            <div class="widget-heading">
                                <h3 class="widget-title text-dark">
                              makanan terpopuler <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true">
                                ...
                                <div class="food-item">
                                    <div class="row">
										...
										<span class="price pull-left" >Rp.<?php echo $product['price']; ?></span>
										  ...
										  <input type="submit" class="btn theme-btn" style="margin-left:40px;" value="Masukan ke Cart" />
										</div>
										</form>
                                    </div>
